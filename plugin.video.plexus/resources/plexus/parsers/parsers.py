...
from plexusutils.webutils import *
from plexusutils.directoryhandle import addDir,addLink
from plexusutils.pluginxbmc import *
from plexusutils.iofile import *

parser_folder = os.path.join(pastaperfil,'parser')
parser_core_folder = os.path.join(addonpath,'resources','plexus','parsers')
