...
from resources.plexus.parsers import parsers                                                                                                                                                                                                                                         
def main_menu():
      addDir("[B][COLOR orange]Website parsers[/COLOR][/B]",MainURL,400,os.path.join(addonpath , art , 'web-parsers-menu.png'),2,True)
...
#from 300-399 Advanced functions
   ...
   package = 'resources.plexus.parsers.' + parser
   tree = "main"
